...
/// </summary>
        ...
        constexpr static std::array<Vector3, 29> arrowPositions = {
            // Shaft
            Vector3(-0.2f, -0.2f, 0.f), Vector3(-0.2f, -0.2f, 0.75f), Vector3(-0.2f, 0.2f, 0.75f),
            Vector3(-0.2f, 0.2f, 0.f),
            Vector3(-0.2f, -0.2f, 0.75f), Vector3(-0.2f, 0.2f, 0.75f), Vector3(0.2f, 0.2f, 0.75f),
            Vector3(0.2f, -0.2f, 0.75f),
            Vector3(-0.2f, -0.2f, 0.f), Vector3(-0.2f, 0.2f, 0.f), Vector3(0.2f, 0.2f, 0.f), Vector3(0.2f, -0.2f, 0.f),
            Vector3(0.2f, -0.2f, 0.f), Vector3(0.2f, -0.2f, 0.75f), Vector3(0.2f, 0.2f, 0.75f),
            Vector3(0.2f, 0.2f, 0.f),
            Vector3(-0.2f, 0.2f, 0.f), Vector3(0.2f, 0.2f, 0.f), Vector3(0.2f, 0.2f, 0.75f),
            Vector3(-0.2f, 0.2f, 0.75f),
            Vector3(-0.2f, -0.2f, 0.f), Vector3(0.2f, -0.2f, 0.f), Vector3(0.2f, -0.2f, 0.75f),
            Vector3(-0.2f, -0.2f, 0.75f),

            // Head
            Vector3(-0.4f, -0.4f, 0.75f), Vector3(-0.4f, 0.4f, 0.75f), Vector3(0.4f, 0.4f, 0.75f),
            Vector3(0.4f, -0.4f, 0.75f),
            Vector3(0.f, 0.f, 1.f)
        };
